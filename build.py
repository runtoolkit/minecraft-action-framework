...
class FrameworkBuilder:
    ...
    def generate_load_function(self):
        ...
        content = f"""# Action Framework Load Function
...
"""
        ...
        output_file = self.output_dir / self.datapack_name / "data" / "action_framework" / "function" / "load.mcfunction"
...
"""
    ...
    def create_documentation(self):
        ...
        usage_guide = f"""# Action Framework Kullanım Kılavuzu
...
"""
    ...
    def create_readme(self):
        ...
        readme = f"""# 🎮 Minecraft Action Framework
